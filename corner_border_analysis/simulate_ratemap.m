function [neuronSim,ratemapSim] = simulate_ratemap(datapath, condition)
...
if strcmp(condition, 'shuttle')
    load('NBindivLR.mat','neuronIndivLR','behavIndivLR','meanFRindividuals')
...
meanFR = cellfun(@mean, meanFRindividuals);
