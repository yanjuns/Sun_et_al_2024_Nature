function [firingrateAll,countAll,countTime] = compute_firing_ratemap(neuron,behav,thresh,binsize,timeInterval,dataType)
...
for jj = 1:numcells;
    firingrateAll{jj} = countAll{jj}./countTime;
end
