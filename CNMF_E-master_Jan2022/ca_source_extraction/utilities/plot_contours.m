function [CC,jsf,cm] = plot_contours(Aor,Cn,thr,display_numbers,max_number,Coor, ln_wd, ln_col)
...
if (0)
    ...
    set(cbar,'fontweight','bold','fontsize',10,'fontname',fontname);
end
...
if display_numbers
    ...
    text((cm(1:max_number,2)),(cm(1:max_number,1)),lbl(1:max_number),'color',[0,0,0],'fontsize',8,'fontname',fontname,'fontweight','bold');
end
axis off;
if ~(nargin < 6 || isempty(Coor))
    jsf = [];
